// MultiWA Gateway - AI Service (worker-local copy)
// apps/worker/src/engine/ai.service.ts
//
// Worker-local copy of apps/api/src/modules/ai/ai.service.ts (reads env directly
// instead of ConfigService). Keep in sync.
